...
//  EssentialFeedTests
//
//  Created by Mendy Edri on 31/10/2019.
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        let requestError = NSError(domain: "any domain", code: 1, userInfo: nil)
    ...
    func test_getFromURL_succeedWithEmpyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
